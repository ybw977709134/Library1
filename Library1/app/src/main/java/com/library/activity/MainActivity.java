...
public class MainActivity extends FragmentActivity implements
    ...
    private ResideMenuItem  y1;
    private ResideMenuItem  y2;
...
//	private ResideMenuInfo info;
	...
	private void setUpMenu() {
		...
		// create menu items;
		y1=new ResideMenuItem(this,R.drawable.icon_profile,"dsdsd");
		y2=new ResideMenuItem(this,R.drawable.icon_profile,"sdsd");
		itemGuanZhangEmail = new ResideMenuItem(this, R.drawable.icon_profile, "馆长信箱");
		itemGrRenXinXi = new ResideMenuItem(this, R.drawable.icon_profile,"我的信息");
		itemZhuangban = new ResideMenuItem(this, R.drawable.icon_profile,"当前查看");
		itemShoucang = new ResideMenuItem(this, R.drawable.icon_profile,"借阅记录");
		itemXiangce = new ResideMenuItem(this,R.drawable.icon_profile,"预约查询");
		itemFile = new ResideMenuItem(this,R.drawable.icon_profile,"违章查询");

		resideMenu.addMenuItem(y1, ResideMenu.DIRECTION_LEFT);
		resideMenu.addMenuItem(y2, ResideMenu.DIRECTION_LEFT);
...
//		resideMenu.addMenuInfo(info);
		...
		resideMenu.findViewById(R.id.shezhi).setOnClickListener(this);
		resideMenu.findViewById(R.id.pifu).setOnClickListener(this);
...
//			intent.setClass(getApplicationContext(), SettingActivity.class);
//			startActivity(intent);
		}else if(view== resideMenu.findViewById(R.id.shezhi)){
			 Intent intent = new Intent();
			 intent.putExtra("flog", "设置页面");
			 intent.setClass(getApplicationContext(), SettingActivity.class);
			 startActivity(intent);
		 }else if(view==resideMenu.findViewById(R.id.pifu)){
			 Intent intent = new Intent();
			 intent.putExtra("flog", "切换皮肤");
			 intent.setClass(getApplicationContext(), SettingActivity.class);
			 startActivity(intent);
		 }
	}
